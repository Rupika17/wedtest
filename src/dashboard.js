...
export default class Dashboard extends React.Component {
  ...
  render() {
    return (
      <div>
        <input  id="filled-search" label="Search field" type="search"  />
        <button onClick={this._showMessage.bind(null, true)}>Search</button>
        
        { this.state.showMessage && (<div> <div style={{marginTop:"30px", textAlign:"right", marginRight:"5px"}}>
               <FormDialog />
               </div>
